...
df_train=pd.read_csv(filepath_or_buffer="./us_address_train_dataset.csv",sep=",",dtype=str)
...
#
# # Get entity spans
# df_entity_spans= create_entity_spans(df_test.astype(list))
# print(df_entity_spans)
#
# # Get & Persist DocBin to disk
